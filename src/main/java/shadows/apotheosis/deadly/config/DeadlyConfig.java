...
public class DeadlyConfig {
	...
	public static boolean canGenerateIn(ISeedReader world) {
		...
		boolean canGenerate = DIM_WHITELIST.contains(key.getLocation());

		// NOTE:
		System.out.println("APOTHEOSIS Deadly Module canGenerateIn(" +  key.getLocation().getPath() + ") -> "+ canGenerate);
